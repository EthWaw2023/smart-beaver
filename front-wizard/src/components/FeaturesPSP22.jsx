...
export default function FeaturesBoxPSP22({formik}) {
  return (
    <>
      <div>
        <Accordion
            ...
            <div className="">
              ...
              <Accordion.Content>
                <div className="flex flex-col gap-3">
                  ...
                  <FormCheckbox formik={formik} name="pausable" label="Pausable" />
                  <FormCheckbox formik={formik} name="capped" label="Capped" />
                </div>
              </Accordion.Content>
            </div>
          </Accordion.Panel>
